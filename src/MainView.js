...
import { BellIcon, CalendarIcon, UserIcon, ChartBarIcon, FolderIcon, HomeIcon, InboxIcon, MenuAlt2Icon, UsersIcon, XIcon } from "@heroicons/react/outline";
            ...
            <div className="flex-1 px-4 flex justify-between">
              ...
              <div className="ml-4 flex items-center md:ml-6">
                ...
                <Menu as="div" className="ml-3 relative">
                  <div>
                    <Menu.Button className="max-w-xs bg-white hover:text-gray-500  text-gray-400 flex items-center text-sm rounded-full focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
          ...
          <main className="flex-1">
            <div className="py-6 pb-10">
              ...
              <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
                ...
                <div className="py-4">
                  <div className="border-4 border-dashed border-gray-200 rounded-lg pb-10">
