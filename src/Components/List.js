...
import { GetFiles, GetLink, Cancel, Delete } from "../ApiClients/Files";
...
export default function ListView() {
  ...
  return (
    <div>
      <ConfirmDialog
        show={fileToDelete === null ? false : true}
        headLine="Confirm delete"
        message={`Confirm delete of ${fileToDelete}`}
        onCancel={() => setFileToDelete(null)}
        onConfirm={() => deleteitem(fileToDelete)}
      ></ConfirmDialog>
                ...
                <table className="min-w-full divide-y divide-gray-300">
                  <thead className="bg-gray-50">
                    <tr>
                      ...
                      <th
                        scope="col"
                        className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 justify-center"
                      >
                        Edit
                      </th>
                      <th
                      ...
                      <tr key={key}>
                        ...
                        <td>
                          <div className="flex flex-row mt-5 gap-x-5 justify-center">
                            ...
                            <div>
                              <button
                                title={item.chedkedOut ? "Co-edit" : "edit"}
                                className="text-indigo-600  hover:text-indigo-900"
                                onClick={() => edit(item.baseFileName)}
                              >
                                {item.chedkedOut ? (
                          ...
                          <div className="flex flex-row mt-5 gap-x-5">
                            ...
                            <div>
                              <button
                                className="text-indigo-600 hover:text-indigo-900"
                                onClick={() =>
                                  setFileToDelete(item.baseFileName)
                                }
                              >
